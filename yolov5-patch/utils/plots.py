...
class Colors:
    ...
    def __init__(self):
        ...
        hexs = ('FF0000', 'FF0000', 'FF0000', 'FF0000', 'FF0000', 'FF0000', 'FF0000', 'FF0000', 'FF0000', 'FF0000',
...
class Annotator:
    ...
    def __init__(self, im, line_width=None, font_size=None, font='Arial.Unicode.ttf', pil=True, example='abc'):
        ...
        if self.pil:  # use PIL
            ...
            self.font = check_pil_font(font='Arial.Unicode.ttf' if non_ascii else font,
                                       size=font_size or max(round(sum(self.im.size) / 4 * 0.035), 12))
        else:  # use cv2
            self.im = im
